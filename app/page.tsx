...
const PRICING = [
  {
    ...
    period: 'one time',
    description:
      'A complete Total Search Optimization audit across SEO, AEO, AIO, and GEO. Know exactly where you stand on every search surface — and exactly what to fix.',
    features: [
  ...
  },
  {
    ...
    period: 'per month',
    description:
      'We execute your entire TSO Fix List every month. Technical fixes, content restructures, AI citation signals, schema, llms.txt, directory submissions — all handled.',
    features: [
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <strong>Your top competitor scores 67/100.</strong> They appear in 73%
          of AI responses when customers search for your services in your city.
          That gap is growing every month.
        </p>
      </div>
    </div>
  )
...
function StatCard({
  ...
  return (
    <div style={{ textAlign: 'center' }}>
      ...
      <div
        className="ar-sans"
        style={{ color: '#555', fontSize: 12, fontWeight: 300, lineHeight: 1.5 }}
      >
        {context}
      </div>
    </div>
      ...
      >
        ...
        >
          <div
            style={{
              ...
              pointerEvents: 'none',
              backgroundImage:
                'linear-gradient(#e8ff4a 1px, transparent 1px), linear-gradient(90deg, #e8ff4a 1px, transparent 1px)',
          ...
          <div
            style={{
              ...
              pointerEvents: 'none',
              background:
                'radial-gradient(circle, rgba(232,255,74,0.07) 0%, transparent 70%)',
            }}
          />
          ...
          <div style={{ position: 'relative', zIndex: 1, maxWidth: 900, width: '100%' }}>
            ...
            >
              Someone just asked ChatGPT
              <br />
              for{' '}
              <span style={{ display: 'inline' }}>
                <span className="ar-ticker-wrap">
                  <span
                    className="ar-ticker-inner ar-serif ar-italic"
                    style={{ color: '#e8ff4a', display: 'block' }}
                  >
                    {industries.map((i) => (
            ...
            >
              AI is now the first stop for millions of buying decisions. Businesses
              that show up in those answers are taking work that used to find you
              through Google. That gap grows every week you don't act.
            </p>
            ...
            >
              Find out your AI Visibility Score across ChatGPT, Perplexity, Gemini,
              and Google AI — and exactly what's costing you.
            </p>
        ...
        <section style={{ padding: '72px 24px', background: '#0a0a0a' }}>
          <div style={{ maxWidth: 720, margin: '0 auto', textAlign: 'center' }}>
            ...
            >
              In 2010, if you weren't on Google,
              <br />
              <span className="ar-italic" style={{ color: '#888' }}>
                you were invisible.
              </span>
            </h2>
            <p
            ...
            >
              We are in that exact same moment with AI — right now. Businesses
              building AI visibility today are compounding an advantage that will be
              expensive and slow to overcome in 12 months. The ones who wait are
              funding someone else's lead.
            </p>
            <p
              className="ar-sans"
              style={{
            ...
            >
              Gartner projects traditional search volume drops 25% by end of 2026.
              That traffic doesn't disappear — it moves to AI. The question is whose
              name comes up when it does.
            </p>
          </div>
        </section>
                ...
                >
                  ...
                  <p
                    ...
                    style={{
                      ...
                      fontWeight: 300,
                      lineHeight: 1.7,
                      marginBottom: 'link' in item ? 12 : 0,
                    }}
                  >
                    {item.body}
                  </p>
            ...
            <div style={{ display: 'flex', flexWrap: 'wrap', gap: 10, alignItems: 'center' }}>
              ...
              {PLATFORMS.map((p) => (
                ...
                >
                  ...
                  />
                  <span className="ar-sans" style={{ color: '#fff', fontSize: 13 }}>
                    {p}
                  </span>
                </div>
              ))}
        ...
        >
          ...
          >
            <div>
              ...
              >
                Your AI Visibility Score is built from five components that reflect
                how AI platforms actually decide who to recommend.
              </p>
              <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
                {[
                  {
                    ...
                    weight: '35%',
                    desc: "How often you're named in relevant queries",
                  },
                  {
                    label: 'Citation source rate',
                    weight: '20%',
                    desc: "How often your content is used as AI's source",
                  },
                  {
                    label: 'Sentiment score',
                    weight: '20%',
                    desc: 'Positive vs. neutral vs. negative framing',
                  },
                  {
                    label: 'Platform coverage',
                    weight: '15%',
                    desc: 'How many of the 4 platforms mention you',
                  },
                  {
                    label: 'Competitor displacement',
                    weight: '10%',
                    desc: 'How often competitors appear instead of you',
                  },
                ].map((item) => (
                  <div
                    key={item.label}
              ...
              {[
                {
                  range: '0–30',
                  label: 'Invisible',
                  desc: 'Not appearing in AI answers at all',
                  color: '#ff4444',
                },
                {
                  range: '31–55',
                  label: 'Weak Signal',
                  desc: 'Mentioned occasionally, inconsistently',
                  color: '#ff8c44',
                },
                {
                  range: '56–75',
                  label: 'Emerging',
                  desc: 'Showing up on some platforms, room to grow',
                  color: '#ffcc44',
                },
                {
                  range: '76–90',
                  label: 'Established',
                  desc: 'Strong presence across most platforms',
                  color: '#88ff44',
                },
                {
                  range: '91–100',
                  label: 'Dominant',
                  desc: 'Consistently cited, positive sentiment',
                  color: '#e8ff4a',
                },
              ].map((band) => (
                <div
        ...
        <section id="pricing" style={{ padding: '96px 24px' }}>
          <div style={{ maxWidth: 960, margin: '0 auto' }}>
            ...
            >
              AnswerRank AI runs your TSO audit — Total Search Optimization across
              SEO, AEO, AIO, and GEO. If you want expert help executing what we
              find, Done-For-You is available.
            </p>
                ...
                >
                  ...
                  <p
                    ...
                    style={{
                      ...
                      textTransform: 'uppercase',
                      marginBottom: 12,
                      color: tier.highlight ? 'rgba(0,0,0,0.45)' : '#555',
                    }}
                  >
                    {tier.name}
                  </p>
                  ...
                  >
                    {tier.features.map((f) => (
                      ...
                      >
                        <span
                          style={{
                            color: tier.highlight ? '#000' : '#e8ff4a',
                            fontSize: 13,
                            flexShrink: 0,
                            marginTop: 1,
                          }}
                        ...
                        <span
                          ...
                          style={{
                            fontSize: 13,
                            fontWeight: 300,
                            color: tier.highlight ? 'rgba(0,0,0,0.75)' : '#888',
                          }}
                        >
                          {f}
                        </span>
                  ...
                  {tier.guarantee && (
                    ...
                    >
                      ...
                      <div>
                        ...
                        >
                          If your report doesn't surface at least 5 specific,
                          actionable fixes — full refund. No questions.
                        </p>
                      </div>
                    </div>
                  )}
                  ...
                  {'scarcityNote' in tier && (
                    <p
                      ...
                      style={{
                        textAlign: 'center',
                        color: tier.highlight ? 'rgba(0,0,0,0.5)' : '#555',
                        fontSize: 12,
                        marginTop: 12,
                      }}
                    >
          ...
          <div style={{ maxWidth: 960, margin: '0 auto' }}>
            <div style={{ textAlign: 'center', marginBottom: 64 }}>
              ...
              >
                ...
                <br />
                <span className="ar-italic" style={{ color: '#e8ff4a' }}>
                  We optimize all four.
                </span>
              </h2>
              <p
                className="ar-sans"
              ...
              >
                The number of places your customers search has changed. The need
                for a 3-month commitment hasn't — that's how compounding works,
                whether it's SEO or TSO. What's different is we're covering every
                surface at once.
              </p>
            </div>
                ...
                >
                  ...
                  >
                    <p
                      ...
                      style={{
                        color:
                          pillar.color === '#e8ff4a' ? '#b8cc3a' : pillar.color,
                        fontSize: 12,
                        fontWeight: 400,
                        margin: 0,
                        lineHeight: 1.5,
            ...
            >
              ...
              >
                $1,497/month · 3-month minimum · Month-to-month after · No
                contracts
              </p>
            </div>
          </div>
          ...
          <div style={{ maxWidth: 960, margin: '0 auto' }}>
            ...
            >
              ...
              <div>
                ...
                >
                  TSO is the most defensible upsell available to agencies right
                  now. Your clients' SEO isn't going away — but the search behavior
                  that feeds it is expanding across channels you're not optimizing
                  yet. Every agency that adds TSO earns a new line item with zero
                  competition from the big SEO platforms.
                </p>
                <p
                  className="ar-sans"
                  style={{
                ...
                >
                  A TSO agency partner program is in development. Book a call and
                  mention it — we're having those conversations now.
                </p>
              </div>
              <div>
                {[
        ...
        >
          ...
          <div
            style={{
              ...
              pointerEvents: 'none',
              background:
                'radial-gradient(ellipse, rgba(232,255,74,0.05) 0%, transparent 65%)',
            }}
          />
          <div style={{ position: 'relative', zIndex: 1, maxWidth: 680, margin: '0 auto' }}>
            ...
            >
              One audit. Four AI platforms. A score, a competitor breakdown, and a
              clear list of what to fix.
            </p>
            <p
              className="ar-sans"
              style={{
            ...
            >
              If we don't surface at least 5 actionable fixes, you pay nothing.
        ...
        >
          ...
          >
            ...
            >
              © 2026 AnswerRank AI · Built by ICC
            </p>
            <div style={{ display: 'flex', gap: 24 }}>
              {['Privacy', 'Terms', 'Contact'].map((item) => (
                <a
                  key={item}
                  href="#"
                  className="ar-sans ar-footer-link"
                  style={{
                    color: '#555',
                    fontSize: 13,
                    transition: 'color 0.2s',
